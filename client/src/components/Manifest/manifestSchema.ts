import { additionalInfoSchema } from 'src/components/Manifest/AdditionalInfo/additionalInfoSchema';
import { rcraPhoneSchema, rcraSite } from 'src/components/RcraSite';
import { z } from 'zod';
...
export const handlerSchema = rcraSite.extend({
  ...
  /**Haztrak specific Property to signify whether the handler has signed*/
...
export const manifestSchema = z
  .object({
    ...
    /** The date-time the manifest was created in the e-Manifest system, managed by EPA's systems.*/
